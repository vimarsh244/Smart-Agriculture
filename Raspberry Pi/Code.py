...
try:
	...
	while 1:
		...
		client2.connect(broker,1887)#connect
		...
		client2.publish("SA/temp",tempVal)#1
		client2.publish("SA/humid",humidVal)#2
		client2.publish("SA/AP",PressureVal)#3
		
		client2.publish("SA/voc",vocVal)#6
		client2.publish("SA/co2",co2Val)#5
		client2.publish("SA/lux",lightVal)#4
