'''	
	This code lets the Raspberry Pi to NXP Rapid IOT via BLE and then gets the data. 
	The data is further transferred to Thingspeak server via MQTT.
'''
...
try:
	...
	while 1:
		...
		client2.connect(ts_broker)#connect
		...
		client2.publish("channels/432689/publish/fields/field1/HH8YDB00AMJ88CNC",tempVal)
		client2.publish("channels/432689/publish/fields/field2/HH8YDB00AMJ88CNC",humidVal)
		client2.publish("channels/432689/publish/fields/field3/HH8YDB00AMJ88CNC",PressureVal)
		
		client2.publish("channels/432689/publish/fields/field6/HH8YDB00AMJ88CNC",vocVal)
		client2.publish("channels/432689/publish/fields/field5/HH8YDB00AMJ88CNC",co2Val)
		client2.publish("channels/432689/publish/fields/field4/HH8YDB00AMJ88CNC",lightVal)
